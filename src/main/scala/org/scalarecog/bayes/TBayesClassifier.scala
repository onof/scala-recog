...
/**
 * TBayes classifier trainer. It computes conditional probabilities needed by the classifier.
 */
 ...
 * TBayes classifier.
 *
 * User: anthonyjschulte@gmail.com
 * Date: 01/11/12
 */
...
/**
 * TBayes classifier companion objects.
